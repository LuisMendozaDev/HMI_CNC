...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_5.setMinimumSize(QSize(449, 192))
        self.frame_5.setMaximumSize(QSize(449, 192))
...
"")
        ...
        self.frame_2.setMinimumSize(QSize(449, 414))
        self.frame_2.setMaximumSize(QSize(449, 414))
...
"color: #FFF;")
        ...
        self.frame_11.setMinimumSize(QSize(71, 240))
        self.frame_11.setMaximumSize(QSize(71, 240))
        self.frame_11.setFrameShape(QFrame.StyledPanel)
        self.frame_11.setFrameShadow(QFrame.Raised)
        self.verticalLayout_11 = QVBoxLayout(self.frame_11)
        self.verticalLayout_11.setObjectName(u"verticalLayout_11")
        self.n_pasos = QLabel(self.frame_11)
        self.n_pasos.setObjectName(u"n_pasos")

        self.verticalLayout_11.addWidget(self.n_pasos)

        self.slider_pasos = QSlider(self.frame_11)
        self.slider_pasos.setObjectName(u"slider_pasos")
        sizePolicy1 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.slider_pasos.sizePolicy().hasHeightForWidth())
        self.slider_pasos.setSizePolicy(sizePolicy1)
        self.slider_pasos.setMinimumSize(QSize(41, 0))
        self.slider_pasos.setMaximumSize(QSize(41, 251))
        self.slider_pasos.setMaximum(100)
        self.slider_pasos.setSingleStep(1)
        self.slider_pasos.setPageStep(10)
        self.slider_pasos.setSliderPosition(5)
        self.slider_pasos.setOrientation(Qt.Vertical)
        self.slider_pasos.setTickPosition(QSlider.TicksAbove)

        self.verticalLayout_11.addWidget(self.slider_pasos)
        ...
        icon1 = QIcon()
        icon1.addFile(u"img/right.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_x_avanza.setIcon(icon1)
        ...
        self.label_7.setMinimumSize(QSize(20, 75))
        self.label_7.setMaximumSize(QSize(20, 75))
        ...
        icon3 = QIcon()
        icon3.addFile(u"img/left.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_x_retrocede.setIcon(icon3)
        ...
        self.label_8.setMinimumSize(QSize(75, 20))
        self.label_8.setMaximumSize(QSize(75, 20))
        ...
        self.label_6.setMinimumSize(QSize(20, 75))
        self.label_6.setMaximumSize(QSize(20, 75))
        ...
        self.label_9.setMaximumSize(QSize(75, 20))
        ...
        self.iso_button.setToolTipDuration(-1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.n_pasos.setText(QCoreApplication.translate("MainWindow", u"Paso: 0.5", None))
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"X [cm]", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Y[cm]", None))
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Z[cm]", None))
#if QT_CONFIG(tooltip)
        self.iso_button.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.iso_button.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
#if QT_CONFIG(accessibility)
        self.iso_button.setAccessibleDescription("")
        ...
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"VELOCIDAD [mm/min]", None))
