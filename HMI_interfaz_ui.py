...
"")
        ...
        self.bt_y_avanza.setIcon(icon)
        self.bt_y_avanza.setIconSize(QSize(50, 50))

        self.gridLayout_2.addWidget(self.bt_y_avanza, 0, 1, 1, 1)
        ...
        self.bt_z_avanza.setIcon(icon)
        self.bt_z_avanza.setIconSize(QSize(50, 50))

        self.gridLayout_2.addWidget(self.bt_z_avanza, 0, 3, 1, 1)
        ...
        self.bt_x_retrocede.setIcon(icon1)
        self.bt_x_retrocede.setIconSize(QSize(50, 50))

        self.gridLayout_2.addWidget(self.bt_x_retrocede, 1, 0, 1, 1)
        ...
        self.bt_x_avanza.setIcon(icon2)
        self.bt_x_avanza.setIconSize(QSize(50, 50))

        self.gridLayout_2.addWidget(self.bt_x_avanza, 1, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.bt_home, 1, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.bt_z_retrocede, 2, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.bt_y_retrocede, 2, 1, 1, 1)
        ...
        self.layoutWidget1.setGeometry(QRect(740, 10, 79, 691))
        ...
        self.x_coord = QLCDNumber(self.layoutWidget1)
        ...
        self.y_coord = QLCDNumber(self.layoutWidget1)
        ...
        self.z_coord = QLCDNumber(self.layoutWidget1)
        ...
        self.iso_button = QPushButton(self.layoutWidget1)
        ...
        self.side_button = QPushButton(self.layoutWidget1)
        ...
        self.top_button = QPushButton(self.layoutWidget1)
        ...
        self.front_button = QPushButton(self.layoutWidget1)
